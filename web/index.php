<?php final class Index{
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'FoodOrderDao' => '../dao/foodOrderDao.php',
            'ProductDao' => '../dao/productDao.php',
            'UserDao' => '../dao/userDao.php',
            //'Menu'=>'../page/menu.php'
            'FoodOrderMapper' => '../mapping/foodOrderMapper.php',
            'ProductMapper' => '../mapping/productMapper.php',
            'UserMapper' => '../mapping/userMapper.php',
            
            'FoodOrder' => '../model/foodOrder.php',
            'ProductOrder' => '../model/productOrder.php',
            'Product' => '../model/product.php',
            'User' => '../model/user.php',
//            'TodoSearchCriteria' => '../dao/TodoSearchCriteria.php',
            //'FoodOrderValidator' => '../validation/foodOrderValidator.php',
